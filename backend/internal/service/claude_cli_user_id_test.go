...
func TestClaudeCLIWorkspaceUserIDForResultUsesConfiguredUserID(t *testing.T) {
	const userID = "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789"

	got := claudeCLIWorkspaceUserIDForResult(&claudeCLIWorkspace{Dir: t.TempDir()}, userID)
